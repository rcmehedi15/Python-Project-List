...
#first button
restart_time_button=PhotoImage(file="rest.PNG")
...
#third button
restart_time_button=PhotoImage(file="restart.png")
third_button=Button(root,image=restart_time_button,borderwidth=0,cursor="Hand2",command=restart)
